defmodule DesafioOinc.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      DesafioOinc.CommandedApplication,

      # User supervisor
      DesafioOinc.Supervisors.UserSupervisor,

      # Contact supervisor
      DesafioOinc.Supervisors.ContactSupervisor,

      # Phone supervisor
      DesafioOinc.Supervisors.PhoneSupervisor
